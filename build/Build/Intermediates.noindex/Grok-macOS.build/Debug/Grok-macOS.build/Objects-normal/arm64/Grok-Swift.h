...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Grok",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC4Grok11AppDelegate")
...
SWIFT_CLASS("_TtC4Grok12WebViewModel")
...
@class NSURL;
@class NSData;
@interface WebViewModel (SWIFT_EXTENSION(Grok)) <WKDownloadDelegate>
...
@interface WebViewModel (SWIFT_EXTENSION(Grok)) <WKNavigationDelegate>
...
@interface WebViewModel (SWIFT_EXTENSION(Grok)) <WKUIDelegate>
